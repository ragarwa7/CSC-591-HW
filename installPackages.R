...
packages <- list('data.table', 'caret','InformationValue','bigmemory','biglm','biganalytics') #Add all your packages here. Don't change the rest of the file, or file name
